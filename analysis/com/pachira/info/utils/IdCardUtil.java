...
public class IdCardUtil {
     ...
     * </pre>
     */
    private static String[] cityCode = {"11", "12", "13", "14", "15", "21", "22", "23", "31",
     ...
     * </p>
     * <p>
     * 第十八位数字(校验码)的计算方法为： 1.将前面的身份证号码17位数分别乘以不同的系数。从第一位到第十七位的系数分别为：7 9 10 5 8 4 2 1 6 3 7 9
     * 10 5 8 4
     * 2
     * </p>
     * <p>
    ...
    public static boolean validate15IDCard(String idcard) {
        ...
        return checkbirthday("19" + birthday);
    }
